...
from sumsub_python_sdk.pydantic.applicant_update_fixed_info_request1_addresses import ApplicantUpdateFixedInfoRequest1Addresses

class ApplicantUpdateFixedInfoRequest1(BaseModel):
    ...
    addresses: typing.Optional[ApplicantUpdateFixedInfoRequest1Addresses] = Field(None, alias='addresses')
