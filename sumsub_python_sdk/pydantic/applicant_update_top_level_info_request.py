...
from sumsub_python_sdk.pydantic.applicant_update_top_level_info_request_metadata import ApplicantUpdateTopLevelInfoRequestMetadata
from sumsub_python_sdk.pydantic.applicant_update_top_level_info_request_questionnaires import ApplicantUpdateTopLevelInfoRequestQuestionnaires

class ApplicantUpdateTopLevelInfoRequest(BaseModel):
    ...
    questionnaires: typing.Optional[ApplicantUpdateTopLevelInfoRequestQuestionnaires] = Field(None, alias='questionnaires')

    metadata: typing.Optional[ApplicantUpdateTopLevelInfoRequestMetadata] = Field(None, alias='metadata')
