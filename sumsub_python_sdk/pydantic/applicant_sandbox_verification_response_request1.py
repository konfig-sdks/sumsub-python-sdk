...
from sumsub_python_sdk.pydantic.applicant_sandbox_verification_response_request1_reject_labels import ApplicantSandboxVerificationResponseRequest1RejectLabels

class ApplicantSandboxVerificationResponseRequest1(BaseModel):
    ...
    reject_labels: ApplicantSandboxVerificationResponseRequest1RejectLabels = Field(alias='rejectLabels')
