...
from sumsub_python_sdk.pydantic.applicant_import_completed_request1_info_addresses import ApplicantImportCompletedRequest1InfoAddresses

class ApplicantImportCompletedRequest1Info(BaseModel):
    ...
    addresses: typing.Optional[ApplicantImportCompletedRequest1InfoAddresses] = Field(None, alias='addresses')
