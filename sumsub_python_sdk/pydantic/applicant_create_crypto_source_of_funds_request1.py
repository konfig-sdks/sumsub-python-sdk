...
class ApplicantCreateCryptoSourceOfFundsRequest1(BaseModel):
    ...
    txn: typing.Optional[str] = Field(None, alias='txn')
    ...
    token_id: typing.Optional[str] = Field(None, alias='tokenId')
