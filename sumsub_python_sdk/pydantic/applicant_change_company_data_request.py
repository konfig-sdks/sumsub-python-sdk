...
from sumsub_python_sdk.pydantic.applicant_change_company_data_request_addresses import ApplicantChangeCompanyDataRequestAddresses
from sumsub_python_sdk.pydantic.applicant_change_company_data_request_beneficiaries import ApplicantChangeCompanyDataRequestBeneficiaries

class ApplicantChangeCompanyDataRequest(BaseModel):
    # Name of the company.
    ...
    beneficiaries: typing.Optional[ApplicantChangeCompanyDataRequestBeneficiaries] = Field(None, alias='beneficiaries')

    addresses: typing.Optional[ApplicantChangeCompanyDataRequestAddresses] = Field(None, alias='addresses')
