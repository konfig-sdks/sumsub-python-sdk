...
from sumsub_python_sdk.pydantic.transaction_bulk_import_request_data import TransactionBulkImportRequestData
...
class TransactionBulkImportRequest(BaseModel):
    ...
    data: TransactionBulkImportRequestData = Field(alias='data')
