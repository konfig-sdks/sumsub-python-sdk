...
class RequiredApplicantAddBeneficiaryRequest(TypedDict):
...
class OptionalApplicantAddBeneficiaryRequest(TypedDict, total=False):
    positions: ApplicantAddBeneficiaryRequestPositions

class ApplicantAddBeneficiaryRequest(RequiredApplicantAddBeneficiaryRequest, OptionalApplicantAddBeneficiaryRequest):
    pass
