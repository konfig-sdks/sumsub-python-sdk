...
class RequiredApplicantSubmitTransactionDataRequestInfo(TypedDict):
...
class OptionalApplicantSubmitTransactionDataRequestInfo(TypedDict, total=False):
...
class ApplicantSubmitTransactionDataRequestInfo(RequiredApplicantSubmitTransactionDataRequestInfo, OptionalApplicantSubmitTransactionDataRequestInfo):
    pass
