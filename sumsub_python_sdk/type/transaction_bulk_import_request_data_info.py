...
class RequiredTransactionBulkImportRequestDataInfo(TypedDict):
...
class OptionalTransactionBulkImportRequestDataInfo(TypedDict, total=False):
...
class TransactionBulkImportRequestDataInfo(RequiredTransactionBulkImportRequestDataInfo, OptionalTransactionBulkImportRequestDataInfo):
    pass
