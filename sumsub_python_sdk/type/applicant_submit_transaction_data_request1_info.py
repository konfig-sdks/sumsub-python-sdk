...
class RequiredApplicantSubmitTransactionDataRequest1Info(TypedDict):
...
class OptionalApplicantSubmitTransactionDataRequest1Info(TypedDict, total=False):
...
class ApplicantSubmitTransactionDataRequest1Info(RequiredApplicantSubmitTransactionDataRequest1Info, OptionalApplicantSubmitTransactionDataRequest1Info):
    pass
