...
class RequiredApplicantSubmitTransactionDataRequest(TypedDict):
...
class OptionalApplicantSubmitTransactionDataRequest(TypedDict, total=False):
...
class ApplicantSubmitTransactionDataRequest(RequiredApplicantSubmitTransactionDataRequest, OptionalApplicantSubmitTransactionDataRequest):
    pass
