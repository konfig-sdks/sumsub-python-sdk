...
class RequiredApplicantSubmitTransactionForNonExistingRequestInfo(TypedDict):
...
class OptionalApplicantSubmitTransactionForNonExistingRequestInfo(TypedDict, total=False):
...
class ApplicantSubmitTransactionForNonExistingRequestInfo(RequiredApplicantSubmitTransactionForNonExistingRequestInfo, OptionalApplicantSubmitTransactionForNonExistingRequestInfo):
    pass
