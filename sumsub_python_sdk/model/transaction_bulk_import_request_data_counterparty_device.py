...
class TransactionBulkImportRequestDataCounterpartyDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['TransactionBulkImportRequestDataCounterpartyDeviceAddress']:
                return TransactionBulkImportRequestDataCounterpartyDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['TransactionBulkImportRequestDataCounterpartyDeviceCoords']:
                return TransactionBulkImportRequestDataCounterpartyDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['TransactionBulkImportRequestDataCounterpartyDeviceIpInfo']:
                return TransactionBulkImportRequestDataCounterpartyDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'TransactionBulkImportRequestDataCounterpartyDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'TransactionBulkImportRequestDataCounterpartyDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'TransactionBulkImportRequestDataCounterpartyDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['TransactionBulkImportRequestDataCounterpartyDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['TransactionBulkImportRequestDataCounterpartyDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['TransactionBulkImportRequestDataCounterpartyDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['TransactionBulkImportRequestDataCounterpartyDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['TransactionBulkImportRequestDataCounterpartyDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['TransactionBulkImportRequestDataCounterpartyDeviceIpInfo', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TransactionBulkImportRequestDataCounterpartyDevice':
