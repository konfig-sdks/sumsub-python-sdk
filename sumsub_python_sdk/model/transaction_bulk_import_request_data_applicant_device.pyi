...
class TransactionBulkImportRequestDataApplicantDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['TransactionBulkImportRequestDataApplicantDeviceAddress']:
                return TransactionBulkImportRequestDataApplicantDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['TransactionBulkImportRequestDataApplicantDeviceCoords']:
                return TransactionBulkImportRequestDataApplicantDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['TransactionBulkImportRequestDataApplicantDeviceIpInfo']:
                return TransactionBulkImportRequestDataApplicantDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'TransactionBulkImportRequestDataApplicantDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'TransactionBulkImportRequestDataApplicantDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'TransactionBulkImportRequestDataApplicantDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['TransactionBulkImportRequestDataApplicantDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['TransactionBulkImportRequestDataApplicantDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['TransactionBulkImportRequestDataApplicantDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['TransactionBulkImportRequestDataApplicantDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['TransactionBulkImportRequestDataApplicantDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['TransactionBulkImportRequestDataApplicantDeviceIpInfo', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TransactionBulkImportRequestDataApplicantDevice':
