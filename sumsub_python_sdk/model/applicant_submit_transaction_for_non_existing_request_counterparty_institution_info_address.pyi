...
class ApplicantSubmitTransactionForNonExistingRequestCounterpartyInstitutionInfoAddress(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequestCounterpartyInstitutionInfoAddress':
