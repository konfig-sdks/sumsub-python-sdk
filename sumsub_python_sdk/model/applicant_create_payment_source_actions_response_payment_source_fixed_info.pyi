...
class ApplicantCreatePaymentSourceActionsResponsePaymentSourceFixedInfo(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["institutionName", "fullName", "accountIdentifier", "email", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["institutionName", "fullName", "accountIdentifier", "email", ], str]):
