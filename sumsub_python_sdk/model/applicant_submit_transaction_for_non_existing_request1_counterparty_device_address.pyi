...
class ApplicantSubmitTransactionForNonExistingRequest1CounterpartyDeviceAddress(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequest1CounterpartyDeviceAddress':
