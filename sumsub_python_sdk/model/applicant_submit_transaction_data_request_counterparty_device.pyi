...
class ApplicantSubmitTransactionDataRequestCounterpartyDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['ApplicantSubmitTransactionDataRequestCounterpartyDeviceAddress']:
                return ApplicantSubmitTransactionDataRequestCounterpartyDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['ApplicantSubmitTransactionDataRequestCounterpartyDeviceCoords']:
                return ApplicantSubmitTransactionDataRequestCounterpartyDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['ApplicantSubmitTransactionDataRequestCounterpartyDeviceIpInfo']:
                return ApplicantSubmitTransactionDataRequestCounterpartyDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'ApplicantSubmitTransactionDataRequestCounterpartyDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'ApplicantSubmitTransactionDataRequestCounterpartyDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'ApplicantSubmitTransactionDataRequestCounterpartyDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['ApplicantSubmitTransactionDataRequestCounterpartyDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['ApplicantSubmitTransactionDataRequestCounterpartyDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['ApplicantSubmitTransactionDataRequestCounterpartyDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['ApplicantSubmitTransactionDataRequestCounterpartyDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['ApplicantSubmitTransactionDataRequestCounterpartyDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['ApplicantSubmitTransactionDataRequestCounterpartyDeviceIpInfo', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ApplicantSubmitTransactionDataRequestCounterpartyDevice':
