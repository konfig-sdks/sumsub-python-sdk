...
class ApplicantSubmitTransactionForNonExistingRequest1CounterpartyDeviceCoords(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequest1CounterpartyDeviceCoords':
