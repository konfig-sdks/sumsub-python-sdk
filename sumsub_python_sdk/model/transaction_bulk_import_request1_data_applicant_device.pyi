...
class TransactionBulkImportRequest1DataApplicantDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['TransactionBulkImportRequest1DataApplicantDeviceAddress']:
                return TransactionBulkImportRequest1DataApplicantDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['TransactionBulkImportRequest1DataApplicantDeviceCoords']:
                return TransactionBulkImportRequest1DataApplicantDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['TransactionBulkImportRequest1DataApplicantDeviceIpInfo']:
                return TransactionBulkImportRequest1DataApplicantDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'TransactionBulkImportRequest1DataApplicantDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'TransactionBulkImportRequest1DataApplicantDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'TransactionBulkImportRequest1DataApplicantDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['TransactionBulkImportRequest1DataApplicantDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['TransactionBulkImportRequest1DataApplicantDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['TransactionBulkImportRequest1DataApplicantDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['TransactionBulkImportRequest1DataApplicantDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['TransactionBulkImportRequest1DataApplicantDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['TransactionBulkImportRequest1DataApplicantDeviceIpInfo', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TransactionBulkImportRequest1DataApplicantDevice':
