...
class ApplicantConfirmDataRequest1Oauth(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["completeUrl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["completeUrl", ], str]):
    ...
    ) -> 'ApplicantConfirmDataRequest1Oauth':
