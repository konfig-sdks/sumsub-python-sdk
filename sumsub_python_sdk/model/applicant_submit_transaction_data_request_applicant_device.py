...
class ApplicantSubmitTransactionDataRequestApplicantDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['ApplicantSubmitTransactionDataRequestApplicantDeviceAddress']:
                return ApplicantSubmitTransactionDataRequestApplicantDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['ApplicantSubmitTransactionDataRequestApplicantDeviceCoords']:
                return ApplicantSubmitTransactionDataRequestApplicantDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo']:
                return ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'ApplicantSubmitTransactionDataRequestApplicantDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'ApplicantSubmitTransactionDataRequestApplicantDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['ApplicantSubmitTransactionDataRequestApplicantDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['ApplicantSubmitTransactionDataRequestApplicantDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['ApplicantSubmitTransactionDataRequestApplicantDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['ApplicantSubmitTransactionDataRequestApplicantDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['ApplicantSubmitTransactionDataRequestApplicantDeviceIpInfo', schemas.Unset] = schemas.unset,
