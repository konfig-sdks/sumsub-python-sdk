...
class ApplicantSubmitTransactionDataRequest1ApplicantDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['ApplicantSubmitTransactionDataRequest1ApplicantDeviceAddress']:
                return ApplicantSubmitTransactionDataRequest1ApplicantDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['ApplicantSubmitTransactionDataRequest1ApplicantDeviceCoords']:
                return ApplicantSubmitTransactionDataRequest1ApplicantDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['ApplicantSubmitTransactionDataRequest1ApplicantDeviceIpInfo']:
                return ApplicantSubmitTransactionDataRequest1ApplicantDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'ApplicantSubmitTransactionDataRequest1ApplicantDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'ApplicantSubmitTransactionDataRequest1ApplicantDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'ApplicantSubmitTransactionDataRequest1ApplicantDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['ApplicantSubmitTransactionDataRequest1ApplicantDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['ApplicantSubmitTransactionDataRequest1ApplicantDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['ApplicantSubmitTransactionDataRequest1ApplicantDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['ApplicantSubmitTransactionDataRequest1ApplicantDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['ApplicantSubmitTransactionDataRequest1ApplicantDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['ApplicantSubmitTransactionDataRequest1ApplicantDeviceIpInfo', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ApplicantSubmitTransactionDataRequest1ApplicantDevice':
