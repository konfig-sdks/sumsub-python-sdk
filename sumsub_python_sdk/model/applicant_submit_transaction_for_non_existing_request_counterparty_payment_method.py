...
class ApplicantSubmitTransactionForNonExistingRequestCounterpartyPaymentMethod(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequestCounterpartyPaymentMethod':
