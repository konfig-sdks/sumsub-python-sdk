...
class TransactionBulkImportRequest1DataCounterpartyDevice(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['TransactionBulkImportRequest1DataCounterpartyDeviceAddress']:
                return TransactionBulkImportRequest1DataCounterpartyDeviceAddress
        
            @staticmethod
            def coords() -> typing.Type['TransactionBulkImportRequest1DataCounterpartyDeviceCoords']:
                return TransactionBulkImportRequest1DataCounterpartyDeviceCoords
        
            @staticmethod
            def ipInfo() -> typing.Type['TransactionBulkImportRequest1DataCounterpartyDeviceIpInfo']:
                return TransactionBulkImportRequest1DataCounterpartyDeviceIpInfo
            __annotations__ = {
                "userAgent": userAgent,
                "sessionId": sessionId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'TransactionBulkImportRequest1DataCounterpartyDeviceAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["coords"]) -> 'TransactionBulkImportRequest1DataCounterpartyDeviceCoords': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ipInfo"]) -> 'TransactionBulkImportRequest1DataCounterpartyDeviceIpInfo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['TransactionBulkImportRequest1DataCounterpartyDeviceAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["coords"]) -> typing.Union['TransactionBulkImportRequest1DataCounterpartyDeviceCoords', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipInfo"]) -> typing.Union['TransactionBulkImportRequest1DataCounterpartyDeviceIpInfo', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address: typing.Union['TransactionBulkImportRequest1DataCounterpartyDeviceAddress', schemas.Unset] = schemas.unset,
        coords: typing.Union['TransactionBulkImportRequest1DataCounterpartyDeviceCoords', schemas.Unset] = schemas.unset,
        ipInfo: typing.Union['TransactionBulkImportRequest1DataCounterpartyDeviceIpInfo', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'TransactionBulkImportRequest1DataCounterpartyDevice':
