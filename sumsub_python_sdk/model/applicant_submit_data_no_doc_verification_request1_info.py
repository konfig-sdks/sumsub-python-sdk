...
class ApplicantSubmitDataNoDocVerificationRequest1Info(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["country", "tin", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["country", "tin", ], str]):
    ...
    ) -> 'ApplicantSubmitDataNoDocVerificationRequest1Info':
