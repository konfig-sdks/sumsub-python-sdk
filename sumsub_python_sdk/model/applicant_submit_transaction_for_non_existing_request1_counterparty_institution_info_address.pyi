...
class ApplicantSubmitTransactionForNonExistingRequest1CounterpartyInstitutionInfoAddress(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequest1CounterpartyInstitutionInfoAddress':
