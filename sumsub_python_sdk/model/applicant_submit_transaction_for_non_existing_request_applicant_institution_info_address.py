...
class ApplicantSubmitTransactionForNonExistingRequestApplicantInstitutionInfoAddress(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequestApplicantInstitutionInfoAddress':
