...
class TransactionUpdateBlockchainInfoRequest1(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fingerprint", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fingerprint", ], str]):
