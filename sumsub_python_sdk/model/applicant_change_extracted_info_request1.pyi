...
class ApplicantChangeExtractedInfoRequest1(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["firstName", "lastName", "middleName", "legalName", "gender", "dob", "placeOfBirth", "countryOfBirth", "stateOfBirth", "country", "nationality", "addresses", "tin", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["firstName", "lastName", "middleName", "legalName", "gender", "dob", "placeOfBirth", "countryOfBirth", "stateOfBirth", "country", "nationality", "addresses", "tin", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        addresses: typing.Union[MetaOapg.properties.addresses, str, schemas.Unset] = schemas.unset,
