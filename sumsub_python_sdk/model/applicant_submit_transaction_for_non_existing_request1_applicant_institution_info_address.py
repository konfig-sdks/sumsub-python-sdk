...
class ApplicantSubmitTransactionForNonExistingRequest1ApplicantInstitutionInfoAddress(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequest1ApplicantInstitutionInfoAddress':
