...
class ApplicantSubmitTransactionForNonExistingRequest1CounterpartyPaymentMethod(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ApplicantSubmitTransactionForNonExistingRequest1CounterpartyPaymentMethod':
