    ...
    async def _aget_actions_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/resources/applicantActions/-;applicantId={applicantId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetActionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_actions(
        self,
        applicant_id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_actions_mapped_args(
            applicant_id=applicant_id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_actions_oapg(
    ...
    def get_actions(
        ...
        return self._get_actions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetActions(BaseApi):
    ...
    async def aget_actions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_actions(
            applicant_id=applicant_id,
            limit=limit,
            offset=offset,
            **kwargs,
    ...
    def get_actions(
        ...
        raw_response = self.raw.get_actions(
            applicant_id=applicant_id,
            limit=limit,
            offset=offset,
        )
