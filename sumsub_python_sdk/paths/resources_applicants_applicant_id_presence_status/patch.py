...
class BaseApi(api_client.Api):
    ...
    def _deactivate_profile_mapped_args(
        self,
        applicant_id: str,
        status: str,
    ...
    async def _adeactivate_profile_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/resources/applicants/{applicantId}/presence/{status}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeactivateProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adeactivate_profile(
        self,
        applicant_id: str,
        status: str,
        **kwargs,
        ...
        args = self._deactivate_profile_mapped_args(
            applicant_id=applicant_id,
            status=status,
        )
        return await self._adeactivate_profile_oapg(
    ...
    def deactivate_profile(
        ...
        return self._deactivate_profile_oapg(
            path_params=args.path,
        )

class DeactivateProfile(BaseApi):
    ...
    async def adeactivate_profile(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adeactivate_profile(
            applicant_id=applicant_id,
            status=status,
            **kwargs,
        )
    ...
    def deactivate_profile(
        ...
        raw_response = self.raw.deactivate_profile(
            applicant_id=applicant_id,
            status=status,
        )
