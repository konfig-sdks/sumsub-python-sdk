...
class BaseApi(api_client.Api):
    ...
    def _initiate_applicant_check_mapped_args(
        self,
        applicant_id: str,
    ...
    async def _ainitiate_applicant_check_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/resources/applicants/{applicantId}/status/pending?reason={reason}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _initiate_applicant_check_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class InitiateApplicantCheckRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainitiate_applicant_check(
        self,
        applicant_id: str,
        reason: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._initiate_applicant_check_mapped_args(
            applicant_id=applicant_id,
            reason=reason,
        )
        return await self._ainitiate_applicant_check_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def initiate_applicant_check(
        self,
        applicant_id: str,
        reason: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._initiate_applicant_check_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class InitiateApplicantCheck(BaseApi):
    ...
    async def ainitiate_applicant_check(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainitiate_applicant_check(
            applicant_id=applicant_id,
            reason=reason,
            **kwargs,
        )
    ...
    def initiate_applicant_check(
        ...
        raw_response = self.raw.initiate_applicant_check(
            applicant_id=applicant_id,
            reason=reason,
        )
